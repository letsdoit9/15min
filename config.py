...
# Ye 503 Nifty500 stocks hain, uploaded CSV (nifty500_instrument_keys.csv)
# se hardcode kiye gaye hain. Apni marzi se yaha se koi stock hata/add kar sakte ho.
# ---------------------------------------------------------
WATCHLIST = {
    ...
    "RAYMONDLSL": "NSE_EQ|INE02ID01020",
    ...
    "KIRLOSBROS": "NSE_EQ|INE732A01036",
